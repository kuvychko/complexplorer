...
class TestPlotLandscape:
    ...
    def test_plot_landscape_basic(self):
        ...
        plot_landscape(domain, func=func, n=30)
    ...
    def test_plot_landscape_with_cmap(self):
        ...
        for cmap in cmaps:
            plot_landscape(domain, func=func, cmap=cmap, n=30)
    ...
    def test_plot_landscape_logarithmic_z(self):
        ...
        plot_landscape(domain, func=func, zaxis_log=True, n=30)
        # Check figure was created
        fig = plt.gcf()
        assert len(fig.axes) == 1
        plt.close()
    ...
    def test_plot_landscape_z_max(self):
        ...
        # Test with z_max
        plot_landscape(domain, func=func, z_max=10, n=30)
        # Check figure was created
        fig = plt.gcf()
        assert len(fig.axes) == 1
        plt.close()
        ...
        with pytest.raises(ValueError, match="z_max must be positive"):
            plot_landscape(domain, func=func, z_max=-1)
    ...
    def test_plot_landscape_with_arrays(self):
        ...
        plot_landscape(domain=None, z=z, f=f)
        # Check figure was created
        fig = plt.gcf()
        assert len(fig.axes) == 1
        plt.close()
    ...
    def test_plot_landscape_antialiased(self):
        ...
        plot_landscape(domain, func=func, antialiased=True, n=20)
        # Check figure was created
        fig = plt.gcf()
        assert len(fig.axes) == 1
        plt.close()
    ...
    def test_plot_landscape_with_existing_axes(self):
        ...
        returned_ax = plot_landscape(domain, func=func, ax=ax, n=20)
...
class TestPairPlotLandscape:
    ...
    def test_pair_plot_landscape_basic(self):
        ...
        pair_plot_landscape(domain, func=func, n=30)
    ...
    def test_pair_plot_landscape_with_options(self):
        ...
        cmap = Phase(n_phi=12)  # Enhanced phase portrait
        pair_plot_landscape(
            domain, func, 
            cmap=cmap, 
            zaxis_log=True,
    ...
    def test_pair_plot_landscape_figsize(self):
        ...
        pair_plot_landscape(domain, func=func, figsize=(12, 6), n=20)
    ...
    def test_pair_plot_landscape_title(self):
        ...
        pair_plot_landscape(domain, func=func, title="Exponential Function", n=20)
...
class TestRiemann:
    ...
    def test_riemann_with_cmap(self):
        ...
        cmap = Phase(n_phi=6)  # Basic phase portrait
        riemann(func, cmap=cmap, n=30)
        plt.close()
...
class Test3DPlottingEdgeCases:
    ...
    def test_riemann_with_poles_at_infinity(self):
        ...
        func = lambda z: np.divide(z**3 + 1, z, out=np.full_like(z, np.inf), where=(z!=0))
        riemann(func, n=30)
        plt.close()
...
class Test3DPlotSaving:
    ...
    def test_pair_plot_landscape_save(self, tmp_path):
        ...
        pair_plot_landscape(domain, func=func, filename=str(filename), n=20)
...
class TestMemoryAndPerformance:
    ...
    def test_large_mesh_handling(self):
        ...
        plot_landscape(domain, func=func, n=100)
        # Check figure was created
        fig = plt.gcf()
        assert len(fig.axes) == 1
        plt.close()
