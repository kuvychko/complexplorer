...
from complexplorer.plotting.base import Base2DPlotter, Base3DPlotter, BasePlotter, PlotConfig
...
class TestBase3DPlotter:
    ...
    def test_apply_3d_styling(self):
        ...
        plotter._apply_3d_styling(
            mock_ax, title="3D Test", xlabel="X", ylabel="Y", zlabel="Z", elev=45, azim=60
        )
...
class TestPlotConfig:
    ...
    def test_custom_values(self):
        ...
        config = PlotConfig(figsize=(10, 10), title="Custom", colorbar=False, custom_param="value")
    ...
    def test_update_method(self):
        ...
        config.update(figsize=(12, 12), title="Updated", new_param="new")
