...
class TestMatplotlib3DPlotter:
    ...
    def test_plot_landscape_with_log(self):
        ...
        ax = plotter.plot_landscape(domain, func, colormap, resolution=40, zaxis_log=True)
    ...
    def test_plot_landscape_with_z_max(self):
        ...
        ax = plotter.plot_landscape(domain, func, colormap, resolution=30, z_max=5.0)
    ...
    def test_invalid_z_max(self):
        ...
        with pytest.raises(ValidationError, match="positive"):
            plotter.plot_landscape(domain, func, colormap, resolution=20, z_max=-1.0)
...
class TestPairPlotLandscape:
    ...
    def test_with_title(self):
        ...
        fig = pair_plot_landscape(domain=domain, func=func, title="Logarithm", resolution=30)
    ...
    def test_with_log_scale(self):
        ...
        fig = pair_plot_landscape(domain=domain, func=func, zaxis_log=True, resolution=50)
    ...
    def test_save_to_file(self, tmp_path):
        ...
        fig = pair_plot_landscape(domain=domain, func=func, resolution=30, filename=str(filename))
...
class TestIntegration3D:
    ...
    def test_poles_and_zeros(self):
        ...
        plot_landscape(domain=domain, func=func, resolution=60, zaxis_log=True, z_max=10)
        plt.close("all")
    ...
    def test_oscillating_function(self):
        ...
        fig = pair_plot_landscape(
            domain=domain, func=func, resolution=100, title="Oscillating Function"
        )
