...
from complexplorer.plotting.matplotlib.plot_3d import pair_plot_landscape, plot_landscape
...
class TestModulusScaling:
    ...
    def test_constant_mode(self):
        ...
        ax = plot_landscape(domain=domain, func=func, resolution=20, modulus_mode="constant")
        assert isinstance(ax, Axes3D)
        plt.close("all")
    ...
    def test_arctan_mode(self):
        ...
        ax = plot_landscape(domain=domain, func=func, resolution=30, modulus_mode="arctan")
        assert isinstance(ax, Axes3D)
        plt.close("all")
    ...
    def test_logarithmic_mode(self):
        ...
        ax = plot_landscape(domain=domain, func=func, resolution=30, modulus_mode="logarithmic")
        assert isinstance(ax, Axes3D)
        plt.close("all")
    ...
    def test_custom_mode_missing_func(self):
        ...
        with pytest.raises(ValidationError, match="Custom mode requires"):
            plot_landscape(domain=domain, func=func, modulus_mode="custom", modulus_params={})
    ...
    def test_unknown_mode(self):
        ...
        with pytest.raises(ValidationError, match="Unknown scaling mode"):
            plot_landscape(domain=domain, func=func, modulus_mode="invalid_mode")
    ...
    def test_with_zaxis_log(self):
        ...
        ax = plot_landscape(
            domain=domain, func=func, resolution=25, modulus_mode="arctan", zaxis_log=True
        )
        assert isinstance(ax, Axes3D)
        plt.close("all")
...
class TestPairPlotModulus:
    ...
    def test_pair_plot_with_modulus(self):
        ...
        fig = pair_plot_landscape(domain=domain, func=func, resolution=20, modulus_mode="arctan")
...
class TestIntegrationWithColormaps:
    ...
    def test_adaptive_scaling(self):
        ...
        ax = plot_landscape(
            ...
            modulus_params={"low_percentile": 20, "high_percentile": 80},
        )
        assert isinstance(ax, Axes3D)
        plt.close("all")
...
class TestEdgeCases:
    ...
    def test_constant_function(self):
        ...
        ax = plot_landscape(domain=domain, func=func, resolution=20, modulus_mode="linear")
        assert isinstance(ax, Axes3D)
        plt.close("all")
    ...
    def test_infinite_values(self):
        ...
        ax = plot_landscape(domain=domain, func=func, resolution=20, modulus_mode="arctan")
        assert isinstance(ax, Axes3D)
        plt.close("all")
    ...
    def test_default_params(self):
        ...
        for mode in ["linear", "arctan", "logarithmic", "power"]:
            ax = plot_landscape(domain=domain, func=func, resolution=20, modulus_mode=mode)
            assert isinstance(ax, Axes3D)
            plt.close("all")
