...
class TestImageExporter:
    ...
    def test_export_success(self, tmp_path):
        ...
        mock_fig.savefig.assert_called_once_with(
            filepath, dpi=150, bbox_inches="tight", transparent=True
        )
...
class TestExportConfig:
    ...
    def test_custom_values(self):
        ...
        config = ExportConfig(dpi=300, transparent=True, custom_param="value")
    ...
    def test_to_dict(self):
        ...
        config = ExportConfig(dpi=200, extra_param="extra")
